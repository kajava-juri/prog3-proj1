...
// ITEM5 *pit5 = (ITEM5 *)GetItem(5, "Taevakarva Sinine");
// Constructs iten of type 5, ID is "Taevakarva Sinine". Important: the color names must consist of two words.
// The first letter of the both components must be uppercase. 
